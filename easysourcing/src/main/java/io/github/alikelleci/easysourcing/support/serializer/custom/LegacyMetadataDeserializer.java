...
public class LegacyMetadataDeserializer extends StdDeserializer<Metadata> {

  public LegacyMetadataDeserializer() {
    this(null);
  }

  protected LegacyMetadataDeserializer(Class<?> vc) {
    super(vc);
  }
