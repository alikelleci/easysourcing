...
import io.github.alikelleci.easysourcing.common.Handler;
import io.github.alikelleci.easysourcing.core.commands.Command;
import io.github.alikelleci.easysourcing.core.exceptions.exceptions.ExceptionProcessingException;
...
public class ExceptionHandler implements Handler<Void> {
  ...
  public Void invoke(Object... args) {
    ...
    log.debug("Handling exceptiont: {} ({})", command.getType(), command.getAggregateId());
